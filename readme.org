...
- a demo emacs configuration \\
  Of course the one purpose of this library is to write emacs configuration directtly in an org file. \\
  For examle, I can write elisp configurations directlly in this file:
