...
and convert every key and value to a elisp symbol(test is here:ref:test-literate-read-org-options).
#+BEGIN_SRC elisp
...
#+END_SRC
*** test literate-read-org-options
label:test-literate-read-org-options
#+BEGIN_SRC elisp
